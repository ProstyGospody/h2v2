          ...
          <div className="space-y-7">
            ...
            <div className="flex flex-col items-center gap-5 text-center">
              <motion.div initial={{ scale: 0, rotate: -180 }} animate={{ scale: 1, rotate: 0 }} transition={{ type: "spring", stiffness: 200, damping: 15, delay: 0.2 }} className="relative">
                <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-accent to-cyan-400 opacity-35 blur-xl" />
                <div className="relative grid h-14 w-14 place-items-center rounded-2xl bg-gradient-to-br from-accent to-cyan-400 text-white shadow-lg shadow-accent/25">
              ...
              <div className="space-y-3.5">
                <div className="relative">
                  ...
                  <input type="email" required autoComplete="username" placeholder="Admin email" {...register("email", { required: true })}
                    className="w-full rounded-xl border border-border bg-surface-0/50 py-3.5 pl-12 pr-4 text-[15px] text-txt outline-none transition-all placeholder:text-txt-muted focus:border-accent/40 focus:bg-surface-0/80 focus:shadow-[0_0_0_3px_rgba(6,182,212,0.08)]" />
                </div>
                <div className="relative">
